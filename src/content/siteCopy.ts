...
export const siteCopy: Record<Locale, SiteCopy> = {
  es: {
    ...
    finalImage: {
      ...
      beforeAfter: {
        beforeLabel: "Luz blanca",
        afterLabel: "H-alpha",
        instruction: "Arrastra el control para comparar la luz blanca (fotosfera, manchas) con la vista en H-alpha (cromosfera, filamentos y protuberancias).",
      },
    },
    glossary: {
      angstrom: {
  ...
  en: {
    ...
    sections: {
      origin: {
        ...
        body: [
          ...
          "That color is produced by hydrogen when one of its electrons changes orbit and releases exactly that amount of energy as red light. Because all hydrogen atoms are identical, they all emit and absorb at that very same wavelength: that is why the line is so sharp and so reliable as a reference.",
        ...
        deepDive: {
          ...
          paragraphs: [
            "In the Bohr model, the electron of hydrogen can only occupy orbits with specific energies, labeled by an integer n = 1, 2, 3... The larger n is, the higher and more loosely bound the electron. Energy is not continuous: it is quantized, which means the atom can only gain or lose energy in discrete jumps between those levels.",
    ...
    finalImage: {
      ...
      beforeAfter: {
        beforeLabel: "White light",
        afterLabel: "H-alpha",
        instruction: "Drag the control to compare white light (photosphere, sunspots) with the H-alpha view (chromosphere, filaments, and prominences).",
      },
    },
    glossary: {
      angstrom: {
