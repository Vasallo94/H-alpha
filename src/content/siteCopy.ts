...
export const siteCopy: Record<Locale, SiteCopy> = {
  es: {
    ...
    social: {
      github: "GitHub",
      linkedin: "LinkedIn",
      githubUrl: "https://github.com/Vasallo94",
    ...
    diagrams: {
      ...
      dopplerTuning: {
        ...
        aria: "Diagrama del perfil de la línea Hα con tres posiciones de la ventana del etalon: centro, ala azul y ala roja.",
        lineLabel: "Perfil de la línea Hα",
        windowLabel: "Ventana del etalon",
        blueshift: "Ala azul",
        redshift: "Ala roja",
        centerLabel: "Centro Hα",
        wingLabel: "Mover la ventana cambia qué gas domina",
        approachingGas: "Gas que se acerca",
        recedingGas: "Gas que se aleja",
        diskDetail: "Disco cromosférico",
  ...
  en: {
    ...
    diagrams: {
      ...
      dopplerTuning: {
        ...
        aria: "Diagram of the Hα line profile with three positions of the etalon window: center, blue wing, and red wing.",
        lineLabel: "Hα line profile",
        windowLabel: "Etalon window",
        blueshift: "Blue wing",
        redshift: "Red wing",
        centerLabel: "Hα center",
        wingLabel: "Moving the window changes which gas dominates",
        approachingGas: "Gas approaching",
        recedingGas: "Gas receding",
        diskDetail: "Chromospheric disk",
